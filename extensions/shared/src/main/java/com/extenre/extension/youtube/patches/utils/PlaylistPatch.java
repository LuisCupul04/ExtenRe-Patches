...
import static com.extenre.extension.youtube.shared.RootView.getContext;
import static com.extenre.extension.youtube.utils.VideoUtils.launchVideoExternalDownloader;
import static com.extenre.extension.youtube.utils.VideoUtils.openPlaylist;
import static com.extenre.extension.youtube.utils.VideoUtils.reloadVideo;
...
import com.extenre.extension.shared.innertube.utils.AuthUtils;
...
import com.extenre.extension.youtube.patches.utils.requests.CreatePlaylistRequest;
import com.extenre.extension.youtube.patches.utils.requests.DeletePlaylistRequest;
import com.extenre.extension.youtube.patches.utils.requests.EditPlaylistRequest;
import com.extenre.extension.youtube.patches.utils.requests.GetPlaylistsRequest;
import com.extenre.extension.youtube.patches.utils.requests.SavePlaylistRequest;
import com.extenre.extension.youtube.patches.utils.requests.VideoDetailsRequest;
...
import com.extenre.extension.youtube.utils.ExtendedUtils;
import kotlin.Pair;
...
public class PlaylistPatch {
    ...
    static {
        ...
        if (mContext != null && mContext.getResources() != null) {
            checkFailedAuth = str("extenre_queue_manager_check_failed_auth");
            checkFailedPlaylistId = str("extenre_queue_manager_check_failed_playlist_id");
            checkFailedQueue = str("extenre_queue_manager_check_failed_queue");
            checkFailedVideoId = str("extenre_queue_manager_check_failed_video_id");
            checkFailedGeneric = str("extenre_queue_manager_check_failed_generic");

            fetchFailedAdd = str("extenre_queue_manager_fetch_failed_add");
            fetchFailedCreate = str("extenre_queue_manager_fetch_failed_create");
            fetchFailedDelete = str("extenre_queue_manager_fetch_failed_delete");
            fetchFailedRemove = str("extenre_queue_manager_fetch_failed_remove");
            fetchFailedSave = str("extenre_queue_manager_fetch_failed_save");
            fetchFailedVideoIndormation =
                    str("extenre_queue_manager_fetch_failed_video_information");

            fetchSucceededAdd = str("extenre_queue_manager_fetch_succeeded_add");
            fetchSucceededCreate = str("extenre_queue_manager_fetch_succeeded_create");
            fetchSucceededDelete = str("extenre_queue_manager_fetch_succeeded_delete");
            fetchSucceededRemove = str("extenre_queue_manager_fetch_succeeded_remove");
            fetchSucceededSave = str("extenre_queue_manager_fetch_succeeded_save");
        }
    }
                ...
                if (request != null) {
                    ...
                    if (message != null) {
                        ...
                        CustomDialog.create(
                                ...
                                mContext,
                                // title
                                str("extenre_queue_manager_video_information"),
                                // message
                                message,
                                // editText
                                null,
                                ...
                                null,
                                // neutralButtonText
                                str("extenre_queue_manager_video_information_copy"),
                                // onNeutralClick
                                () -> Utils.setClipboard(
                                        message,
                                        str("extenre_share_copy_video_information_success")
                                ),
