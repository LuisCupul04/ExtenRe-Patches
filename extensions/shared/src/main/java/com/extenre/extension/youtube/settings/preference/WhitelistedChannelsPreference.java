...
import com.extenre.extension.youtube.whitelist.VideoChannel;
import com.extenre.extension.youtube.whitelist.Whitelist;
import com.extenre.extension.youtube.whitelist.Whitelist.WhitelistType;
...
public class WhitelistedChannelsPreference extends Preference implements Preference.OnPreferenceClickListener {
    ...
    private static void showWhitelistedChannelDialog(Context context, WhitelistType whitelistType) {
        ...
        if (mEntries.isEmpty()) {
            ...
            textView.setText(str("extenre_whitelist_empty"));
            ...
            for (VideoChannel entry : mEntries) {
                ...
                Runnable runnable = () -> {
                    ...
                    Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                            context,
                            null, // No title.
                            str("extenre_whitelist_remove_dialog_message", author, whitelistType.getFriendlyName()), // Message.
                            null, // No EditText.
                            null, // OK button text.
                            () -> {
                                // OK button action.
