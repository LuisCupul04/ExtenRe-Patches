...
import com.extenre.extension.youtube.patches.components.PlaybackSpeedMenuFilter;
        ...
        try {
            ...
            for (String speedString : speedStrings) {
                ...
                if (speedFloat > PLAYBACK_SPEED_MAXIMUM) {
                    resetCustomSpeeds(str("extenre_custom_playback_speeds_invalid", PLAYBACK_SPEED_MAXIMUM));
                    loadCustomSpeeds();
                    return;
                }
