...
import static com.extenre.extension.music.settings.Settings.APP_INFO;
import static com.extenre.extension.music.settings.Settings.BYPASS_IMAGE_REGION_RESTRICTIONS_DOMAIN;
import static com.extenre.extension.music.settings.Settings.CHANGE_START_PAGE;
import static com.extenre.extension.music.settings.Settings.CUSTOM_FILTER_STRINGS;
import static com.extenre.extension.music.settings.Settings.CUSTOM_PLAYBACK_SPEEDS;
import static com.extenre.extension.music.settings.Settings.CUSTOM_PLAYER_BACKGROUND_COLOR_PRIMARY;
import static com.extenre.extension.music.settings.Settings.CUSTOM_PLAYER_BACKGROUND_COLOR_SECONDARY;
import static com.extenre.extension.music.settings.Settings.DISABLE_MUSIC_VIDEO_IN_ALBUM_REDIRECT_TYPE;
import static com.extenre.extension.music.settings.Settings.ENABLE_CUSTOM_NAVIGATION_BAR_COLOR_VALUE;
import static com.extenre.extension.music.settings.Settings.EXTERNAL_DOWNLOADER_PACKAGE_NAME;
import static com.extenre.extension.music.settings.Settings.HIDE_ACCOUNT_MENU_FILTER_STRINGS;
import static com.extenre.extension.music.settings.Settings.OPEN_DEFAULT_APP_SETTINGS;
import static com.extenre.extension.music.settings.Settings.OPTIONAL_SPONSOR_BLOCK_SETTINGS_PREFIX;
import static com.extenre.extension.music.settings.Settings.REPLACE_NAVIGATION_BUTTON_ABOUT;
import static com.extenre.extension.music.settings.Settings.RETURN_YOUTUBE_USERNAME_ABOUT;
import static com.extenre.extension.music.settings.Settings.SB_API_URL;
import static com.extenre.extension.music.settings.Settings.SETTINGS_IMPORT_EXPORT;
import static com.extenre.extension.music.settings.Settings.SPOOF_APP_VERSION_TARGET;
import static com.extenre.extension.music.settings.Settings.SPOOF_APP_VERSION_FOR_LYRICS_TARGET;
import static com.extenre.extension.music.settings.Settings.SPOOF_STREAMING_DATA_DEFAULT_CLIENT;
import static com.extenre.extension.music.settings.Settings.SPOOF_STREAMING_DATA_SIGN_IN_ANDROID_NO_SDK_ABOUT;
import static com.extenre.extension.music.settings.Settings.SPOOF_STREAMING_DATA_SIGN_IN_ANDROID_VR_ABOUT;
import static com.extenre.extension.music.settings.Settings.WATCH_HISTORY_TYPE;
import static com.extenre.extension.music.utils.ExtendedUtils.getDialogBuilder;
import static com.extenre.extension.music.utils.ExtendedUtils.getLayoutParams;
import static com.extenre.extension.music.utils.RestartUtils.showRestartDialog;
import static com.extenre.extension.shared.patches.PatchStatus.PatchVersion;
import static com.extenre.extension.shared.settings.BaseSettings.RETURN_YOUTUBE_USERNAME_DISPLAY_FORMAT;
import static com.extenre.extension.shared.settings.BaseSettings.RETURN_YOUTUBE_USERNAME_YOUTUBE_DATA_API_V3_DEVELOPER_KEY;
import static com.extenre.extension.shared.settings.Setting.getSettingFromPath;
...
import static com.extenre.extension.shared.utils.Utils.isSDKAbove;
import static com.extenre.extension.shared.utils.Utils.showToastShort;
...
import com.extenre.extension.music.patches.utils.ReturnYouTubeDislikePatch;
import com.extenre.extension.music.returnyoutubedislike.ReturnYouTubeDislike;
import com.extenre.extension.music.settings.ActivityHook;
import com.extenre.extension.music.settings.Settings;
import com.extenre.extension.music.utils.ExtendedUtils;
...
import com.extenre.extension.shared.settings.preference.YouTubeDataAPIDialogBuilder;
...
public class ExtenRePreferenceFragment extends PreferenceFragment {
    ...
    private static final String IMPORT_EXPORT_SETTINGS_ENTRY_KEY = "extenre_settings_import_export_entries";
    ...
    private void importExportListDialogBuilder() {
        try {
            ...
            getDialogBuilder(activity)
                    .setTitle(str("extenre_settings_import_export_title"))
    ...
    private void importExportEditTextDialogBuilder() {
        try {
            ...
            getDialogBuilder(activity)
                    ...
                    .setView(container)
                    .setNegativeButton(android.R.string.cancel, null)
                    .setNeutralButton(str("extenre_settings_import_copy"), (dialog, which) -> Utils.setClipboard(textView.getText().toString(), str("extenre_share_copy_settings_success")))
                    .setPositiveButton(str("extenre_settings_import"), (dialog, which) -> importSettings(activity, textView.getText().toString()))
                    .show();
        } catch (Exception ex) {
    ...
    private void exportText(Uri uri) {
        try {
            ...
            showToastShort(str("extenre_settings_export_success"));
        } catch (IOException e) {
            showToastShort(str("extenre_settings_export_failed"));
        }
    }
    ...
    private void importText(Uri uri) {
        ...
        try {
            ...
            showToastShort(str("extenre_settings_import_failed"));
