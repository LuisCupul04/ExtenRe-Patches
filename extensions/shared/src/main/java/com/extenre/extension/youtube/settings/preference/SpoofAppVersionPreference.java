...
import static com.extenre.extension.shared.utils.PackageUtils.isVersionOrGreater;
...
public class SpoofAppVersionPreference extends CustomDialogListPreference {
    ...
    private enum AppVersion {
        ...
        YT_19_26_42(),
        YT_19_01_34(),
        OTHER(sf("extenre_spoof_app_version_other_item").toString());
        ...
        AppVersion() {
            ...
            this.entryName = sf("extenre_spoof_app_version_target_entry_" + tmpVersionName).toString();
    ...
    protected void showDialog(@Nullable Bundle state) {
        ...
        editText.setHint(str("extenre_spoof_app_version_other_item_hint"));
    ...
    private boolean showToastIfAppVersionIsInvalid(String appVersion) {
        if (appVersion.compareTo(Settings.SPOOF_APP_VERSION_TARGET.defaultValue) < 0) {
            Utils.showToastShort(str("extenre_spoof_app_version_target_invalid_toast", appVersion));
