...
package com.extenre.extension.youtube.utils;

import static com.extenre.extension.shared.utils.BaseThemeUtils.getDialogBackgroundColor;
import static com.extenre.extension.shared.utils.ResourceUtils.getString;
...
import static com.extenre.extension.youtube.patches.video.CustomPlaybackSpeedPatch.PLAYBACK_SPEED_MAXIMUM;
import static com.extenre.extension.youtube.patches.video.CustomPlaybackSpeedPatch.SPEED_ADJUSTMENT_CHANGE;
import static com.extenre.extension.youtube.patches.video.PlaybackSpeedPatch.userSelectedPlaybackSpeed;
import static com.extenre.extension.youtube.patches.video.VideoQualityPatch.AUTOMATIC_VIDEO_QUALITY_VALUE;
import static com.extenre.extension.youtube.patches.video.VideoQualityPatch.setCurrentQuality;
import static com.extenre.extension.youtube.utils.ThemeUtils.getAdjustedBackgroundColor;
...
import com.extenre.extension.shared.ui.SheetBottomDialog;
...
import com.extenre.extension.youtube.patches.video.PlaybackSpeedPatch;
import com.extenre.extension.youtube.patches.video.VideoQualityPatch;
import com.extenre.extension.youtube.patches.video.VideoQualityPatch.VideoQualityMenuInterface;
import com.extenre.extension.youtube.settings.Settings;
import com.extenre.extension.youtube.settings.preference.ExternalDownloaderPlaylistPreference;
import com.extenre.extension.youtube.settings.preference.ExternalDownloaderVideoPreference;
import com.extenre.extension.youtube.shared.PlaylistIdPrefix;
import com.extenre.extension.youtube.shared.RootView;
...
public class VideoUtils extends IntentUtils {
    ...
    public static void reloadVideo(@NonNull String videoId, @NonNull String playlistId) {
        if (videoId.isEmpty()) {
            showToastShort(str("extenre_dismiss_player_not_available_toast"));
        } else {
            try {
                dismissPlayer();
        ...
        try {
            ...
            for (float speed : CustomPlaybackSpeedPatch.getPlaybackSpeeds()) {
                ...
                if (speed == 1.0f) {
                    ...
                    normalLabel.setText(str("extenre_playback_speed_normal"));
