...
package com.extenre.extension.shared.patches.auth;

import static com.extenre.extension.shared.patches.auth.requests.AuthRequest.fetch;
import static com.extenre.extension.shared.patches.auth.requests.AuthRoutes.RequestType;
import static com.extenre.extension.shared.utils.StringRef.str;
import static com.extenre.extension.shared.utils.Utils.getDialogBuilder;
...
public class YouTubeVRAuthPatch {
    ...
    public static void clearAll() {
        ...
        Utils.showToastShort(str("extenre_spoof_streaming_data_sign_in_android_vr_toast_reset"));
    }
    ...
    public static void setActivationCode(Context context) {
        ...
        if (jsonObject != null) {
            try {
                ...
                String dialogTitle = str("extenre_spoof_streaming_data_sign_in_android_vr_activation_code_dialog_title");
                String dialogMessage = str("extenre_spoof_streaming_data_sign_in_android_vr_activation_code_dialog_message", activationCode);
                String okButtonText = str("extenre_spoof_streaming_data_sign_in_android_vr_activation_code_dialog_open_website_text");
                Runnable onOkClick = () -> {
                    Utils.setClipboard(
                            activationCode,
                            str("extenre_spoof_streaming_data_sign_in_android_vr_activation_code_toast_copy", activationCode)
                    );
    ...
    public static void setAccessToken(@Nullable Context mContext) {
        ...
        if (jsonObject != null) {
            try {
                ...
                if (mContext != null) {
                    Utils.runOnMainThread(() -> {
                        String dialogTitle =
                                str("extenre_spoof_streaming_data_sign_in_android_vr_success_dialog_title");
                        String dialogMessage =
                                str("extenre_spoof_streaming_data_sign_in_android_vr_success_dialog_message");
            ...
            Utils.showToastShort(str("extenre_spoof_streaming_data_sign_in_android_vr_toast_failed"));
            Utils.showToastShort(str("extenre_spoof_streaming_data_sign_in_android_vr_toast_failed_suggestion"));
        }
    }
