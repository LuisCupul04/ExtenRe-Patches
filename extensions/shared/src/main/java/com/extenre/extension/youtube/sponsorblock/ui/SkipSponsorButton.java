...
import static com.extenre.extension.shared.utils.ResourceUtils.getColor;
import static com.extenre.extension.shared.utils.ResourceUtils.getDimension;
...
import com.extenre.extension.youtube.sponsorblock.objects.SponsorSegment;
...
public class SkipSponsorButton extends FrameLayout {
    ...
    public SkipSponsorButton(Context context, AttributeSet attributeSet, int defStyleAttr, int defStyleRes) {
        ...
        LayoutInflater.from(context).inflate(getLayoutIdentifier("extenre_sb_skip_sponsor_button"), this, true);  // layout:revanced_sb_skip_sponsor_button
        setMinimumHeight(getDimension("ad_skip_ad_button_min_height"));  // dimen:ad_skip_ad_button_min_height
        skipSponsorBtnContainer = (LinearLayout) Objects.requireNonNull((View) findViewById(getIdIdentifier("extenre_sb_skip_sponsor_button_container")));  // id:revanced_sb_skip_sponsor_button_container
        ...
        skipSponsorTextView = (TextView) Objects.requireNonNull((View) findViewById(getIdIdentifier("extenre_sb_skip_sponsor_button_text")));  // id:revanced_sb_skip_sponsor_button_text;
