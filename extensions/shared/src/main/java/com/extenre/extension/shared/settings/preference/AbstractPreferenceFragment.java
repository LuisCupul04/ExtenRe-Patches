...
public abstract class AbstractPreferenceFragment extends PreferenceFragment {
    ...
    protected void initialize() {
        final int identifier = getXmlIdentifier("extenre_prefs");
    ...
    private void showSettingUserDialogConfirmation(Preference pref, Setting<?> setting) {
        ...
        if (confirmDialogTitle == null) {
            confirmDialogTitle = str("extenre_confirm_user_dialog_title");
        }
    ...
    public static void showRestartDialog(@NonNull Context context, String message, long delay) {
        ...
        if (restartDialogTitle == null) {
            restartDialogTitle = str("extenre_restart_title");
        }
        if (restartDialogMessage == null) {
            restartDialogMessage = str("extenre_restart_dialog_message");
        }
        if (restartDialogButtonText == null) {
            restartDialogButtonText = str("extenre_restart");
        }
