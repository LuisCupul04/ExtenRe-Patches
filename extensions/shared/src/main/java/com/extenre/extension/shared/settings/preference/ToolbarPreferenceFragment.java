...
import com.extenre.extension.shared.utils.PackageUtils;
...
public class ToolbarPreferenceFragment extends AbstractPreferenceFragment {
    ...
    protected void exportActivity() {
        if (!settingExportInProgress && !BaseSettings.DEBUG.get()) {
            Utils.showToastShort(str("extenre_debug_logs_disabled"));
            return;
        }
    ...
    protected void exportText(Uri uri) {
        ...
        try {
            ...
            if (settingExportInProgress) {
                ...
                showToastShort(str("extenre_debug_logs_export_success"));
            }
        } catch (IOException e) {
            if (settingExportInProgress) {
                showToastShort(str("extenre_settings_export_failed"));
            } else {
                showToastShort(String.format(str("extenre_debug_logs_failed_to_export"), e.getMessage()));
            }
        } finally {
