...
import com.extenre.extension.shared.utils.Utils.validateColor
import com.extenre.extension.shared.utils.Utils.validateValue
import com.extenre.extension.youtube.settings.Settings
import com.extenre.extension.youtube.shared.LockModeState
...
class SwipeControlsConfigurationProvider {
    ...
    val brightnessSwipeDistance: Float by lazy {
        validateValue(
            ...
            0.1f,
            10f,
            "extenre_swipe_brightness_distance_dip_invalid_toast"
        )
    }
    ...
    val overlayBackgroundOpacity: Int by lazy {
        var opacity = validateValue(
            ...
            0,
            100,
            "extenre_swipe_overlay_background_opacity_invalid_toast"
        )
    ...
    val overlayTextSize: Int by lazy {
        validateValue(
            ...
            1,
            30,
            "extenre_swipe_text_overlay_size_invalid_toast"
        )
    }
