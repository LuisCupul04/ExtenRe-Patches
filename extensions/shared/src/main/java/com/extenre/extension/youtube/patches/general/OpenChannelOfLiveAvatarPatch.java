...
import com.extenre.extension.youtube.patches.general.requests.ChannelIdRequest;
...
public final class OpenChannelOfLiveAvatarPatch {
     ...
     */
    private static final String liveRingDescription = str("extenre_live_ring_description");
