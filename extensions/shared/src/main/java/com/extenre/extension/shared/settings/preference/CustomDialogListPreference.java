...
public class CustomDialogListPreference extends ListPreference {
    ...
    public static final int ID_EXTENRE_CHECK_ICON =
            ResourceUtils.getIdIdentifier("extenre_check_icon");
    public static final int ID_EXTENRE_CHECK_ICON_PLACEHOLDER =
            ResourceUtils.getIdIdentifier("extenre_check_icon_placeholder");
    public static final int ID_EXTENRE_ITEM_TEXT =
            ResourceUtils.getIdIdentifier("extenre_item_text");
    public static final int LAYOUT_EXTENRE_CUSTOM_LIST_ITEM_CHECKED =
            ResourceUtils.getLayoutIdentifier("extenre_custom_list_item_checked");
    ...
    public static class ListPreferenceArrayAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent) {
            ...
            if (view == null) {
                ...
                holder.checkIcon = view.findViewById(ID_EXTENRE_CHECK_ICON);
                holder.placeholder = view.findViewById(ID_EXTENRE_CHECK_ICON_PLACEHOLDER);
                holder.itemText = view.findViewById(ID_EXTENRE_ITEM_TEXT);
                view.setTag(holder);
            } else {
