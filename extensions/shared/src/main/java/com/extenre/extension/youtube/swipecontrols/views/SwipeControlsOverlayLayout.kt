...
package com.extenre.extension.youtube.swipecontrols.views
...
import com.extenre.extension.shared.utils.ResourceUtils.ResourceType
import com.extenre.extension.shared.utils.ResourceUtils.getIdentifier
import com.extenre.extension.shared.utils.StringRef.str
import com.extenre.extension.shared.utils.Utils.dipToPixels
import com.extenre.extension.youtube.swipecontrols.SwipeControlsConfigurationProvider
import com.extenre.extension.youtube.swipecontrols.misc.SwipeControlsOverlay
...
class SwipeControlsOverlayLayout(
    ...
    private var autoBrightnessIcon: Drawable = getDrawable("extenre_ic_sc_brightness_auto")
    private val lowBrightnessIcon: Drawable = getDrawable("extenre_ic_sc_brightness_low")
    private val mediumBrightnessIcon: Drawable = getDrawable("extenre_ic_sc_brightness_medium")
    private val highBrightnessIcon: Drawable = getDrawable("extenre_ic_sc_brightness_high")
    private val fullBrightnessIcon: Drawable = getDrawable("extenre_ic_sc_brightness_full")
    private var manualBrightnessIcon: Drawable = getDrawable("extenre_ic_sc_brightness_manual")
    private var mutedVolumeIcon: Drawable = getDrawable("extenre_ic_sc_volume_mute")
    private val lowVolumeIcon: Drawable = getDrawable("extenre_ic_sc_volume_low")
    private var normalVolumeIcon: Drawable = getDrawable("extenre_ic_sc_volume_normal")
    private val feedbackTextView: TextView
    private val fullVolumeIcon: Drawable = getDrawable("extenre_ic_sc_volume_high")
    ...
    override fun onBrightnessChanged(brightness: Double) {
        if (config.shouldLowestValueEnableAutoBrightness && brightness <= 0) {
            ...
            else str("extenre_swipe_lowest_value_enable_auto_brightness_overlay_text")
