...
package com.extenre.extension.youtube.sponsorblock.objects;

import static com.extenre.extension.shared.utils.StringRef.sf;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_FILLER;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_FILLER_COLOR;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_HIGHLIGHT;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_HIGHLIGHT_COLOR;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_HOOK;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_HOOK_COLOR;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_INTERACTION;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_INTERACTION_COLOR;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_INTRO;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_INTRO_COLOR;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC_COLOR;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_OUTRO;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_OUTRO_COLOR;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_PREVIEW;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_PREVIEW_COLOR;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_SELF_PROMO;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_SELF_PROMO_COLOR;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_SPONSOR;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_SPONSOR_COLOR;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_UNSUBMITTED;
import static com.extenre.extension.youtube.settings.Settings.SB_CATEGORY_UNSUBMITTED_COLOR;
...
public enum SegmentCategory {
     ...
     */
    HIGHLIGHT("poi_highlight", sf("extenre_sb_segments_highlight"), sf("extenre_sb_segments_highlight_sum"), sf("extenre_sb_skip_button_highlight"), sf("extenre_sb_skipped_highlight"),
    ...
    HOOK("hook", sf("extenre_sb_segments_hook"), sf("extenre_sb_segments_hook_sum"), sf("extenre_sb_skip_button_hook"), sf("extenre_sb_skipped_hook"),
    ...
    UNSUBMITTED("unsubmitted", StringRef.empty, StringRef.empty, sf("extenre_sb_skip_button_unsubmitted"), sf("extenre_sb_skipped_unsubmitted"),
            SB_CATEGORY_UNSUBMITTED, SB_CATEGORY_UNSUBMITTED_COLOR);

    private final StringRef skipSponsorTextCompact = sf("extenre_sb_skip_button_compact");
    private final StringRef skipSponsorTextCompactHighlight = sf("extenre_sb_skip_button_compact_highlight");
