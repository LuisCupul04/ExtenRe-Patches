...
import com.extenre.extension.youtube.patches.video.requests.MusicRequest;
                ...
                if (rememberPlaybackSpeedLastSelectedSetting.get()) {
                    ...
                    Utils.runOnMainThreadDelayed(() -> {
                        ...
                        if (showToastSetting.get()) {
                            Utils.showToastShort(str(isShorts ? "extenre_remember_playback_speed_toast_shorts" : "extenre_remember_playback_speed_toast", (finalPlaybackSpeed + "x")));
                        }
