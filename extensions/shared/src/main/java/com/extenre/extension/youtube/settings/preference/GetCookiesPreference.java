...
import static com.extenre.extension.shared.utils.IntentUtils.launchWebViewActivity;
...
public class GetCookiesPreference extends Preference implements Preference.OnPreferenceClickListener {
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                context,
                // Title.
                str("extenre_transcript_cookies_dialog_title"),
                // Message.
                str("extenre_transcript_cookies_dialog_message"),
                // No EditText.
                null,
                // OK button text.
                str("extenre_transcript_cookies_dialog_auth_text"),
                // OK button action.
                ...
                null,
                // Neutral button text.
                str("extenre_transcript_cookies_dialog_no_auth_text"),
