...
public class YouTubeAuthPatch {
    ...
    public static void clearAll() {
        ...
        Utils.showToastShort(str("extenre_spoof_streaming_data_sign_in_android_no_sdk_toast_reset"));
    }
    ...
    public static void setAccessToken(Activity mActivity, String email, String oauthToken) {
        ...
        if (result != null) {
            ...
            if (StringUtils.isNotEmpty(refreshToken) && StringUtils.isNotEmpty(accessToken)) {
                ...
                String dialogTitle =
                        str("extenre_spoof_streaming_data_sign_in_android_no_sdk_success_dialog_title");
                String dialogMessage =
                        str("extenre_spoof_streaming_data_sign_in_android_no_sdk_success_dialog_message");
