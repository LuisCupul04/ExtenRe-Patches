...
See the [documentation](https://github.com/LuisCupul04/ExtenRe-documentation#readme) to learn how to apply patches and build ExtenRe apps.
...
| `Settings for YouTube` | Applies mandatory patches to implement ExtenRe settings into the application. | 19.05.36 ~ 20.05.46 |
...
| `Settings for YouTube Music` | Applies mandatory patches to implement ExtenRe settings into the application. | 6.20.51 ~ 8.30.54 |
...
| `Settings for Reddit` | Applies mandatory patches to implement ExtenRe settings into the application. | 2024.17.0 ~ 2025.12.1 |
</details>
...
This section explains the JSON format for the [patches-RE.json](patches-RE.json) file.
