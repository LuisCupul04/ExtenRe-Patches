...
import static com.extenre.extension.shared.utils.ResourceUtils.getXmlIdentifier;
import static com.extenre.extension.shared.utils.StringRef.str;
import static com.extenre.extension.shared.utils.Utils.getChildView;
import static com.extenre.extension.shared.utils.Utils.hideViewByLayoutParams;
import static com.extenre.extension.shared.utils.Utils.hideViewGroupByMarginLayoutParams;
import static com.extenre.extension.shared.utils.Utils.hideViewUnderCondition;
import static com.extenre.extension.youtube.patches.utils.PatchStatus.ImageSearchButton;
import static com.extenre.extension.youtube.patches.utils.PatchStatus.TargetActivityClass;
...
public class GeneralPatch {
    ...
    private static void openRVXSettings(View view) {
        ...
        Intent intent = new Intent(Intent.ACTION_MAIN);
        intent.setPackage(context.getPackageName());
        intent.setData(Uri.parse("extenre_settings_intent"));
