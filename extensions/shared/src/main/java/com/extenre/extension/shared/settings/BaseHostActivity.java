...
public abstract class BaseHostActivity extends Activity {
    private static final int ID_EXTENRE_SETTINGS_FRAGMENTS =
            getIdIdentifier("extenre_settings_fragments");
    private static final int ID_EXTENRE_TOOLBAR_PARENT =
            getIdIdentifier("extenre_toolbar_parent");
    public static final int LAYOUT_EXTENRE_SETTINGS_WITH_TOOLBAR =
            getLayoutIdentifier("extenre_settings_with_toolbar");
    private static final int STRING_EXTENRE_SETTINGS_TITLE =
            getStringIdentifier("extenre_settings_title");
    ...
    protected void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (!"extenre_settings_intent".equals(dataString)) {
            ...
            getFragmentManager()
                    .beginTransaction()
                    .replace(ID_EXTENRE_SETTINGS_FRAGMENTS, fragment)
                    .commit();
    ...
    protected void createToolbar(PreferenceFragment fragment) {
        ...
        ViewGroup toolBarParent = findViewById(ID_EXTENRE_TOOLBAR_PARENT);
        ViewGroup dummyToolbar = Utils.getChildViewByResourceName(toolBarParent, "extenre_toolbar");
        ...
        toolbar.setTitle(STRING_EXTENRE_SETTINGS_TITLE);
