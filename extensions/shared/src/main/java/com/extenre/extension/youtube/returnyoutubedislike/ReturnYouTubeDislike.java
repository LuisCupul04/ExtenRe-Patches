...
package com.extenre.extension.youtube.returnyoutubedislike;

import static com.extenre.extension.shared.returnyoutubedislike.ReturnYouTubeDislike.Vote;
...
import static com.extenre.extension.shared.utils.Utils.newSpanUsingStylingOfAnotherSpan;
...
import com.extenre.extension.shared.returnyoutubedislike.requests.RYDVoteData;
import com.extenre.extension.shared.returnyoutubedislike.requests.ReturnYouTubeDislikeApi;
        ...
        try {
            ...
            if (votingData == null) {
                ...
                ReturnYouTubeDislikeApi.handleConnectionError(
                        str("extenre_ryd_failure_connection_timeout"),
