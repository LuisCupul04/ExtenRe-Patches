...
import com.extenre.extension.shared.innertube.requests.InnerTubeRoutes.GET_VIDEO_DETAILS
            ...
            try {
                ...
                if (!author.isNullOrEmpty() && !title.isNullOrEmpty()) {
                    return if (description.isNullOrEmpty()) {
                        str(
                            "extenre_queue_manager_video_information_no_description_user_dialog_message",
                            author,
                            title
                        )
                    } else {
                        str(
                            "extenre_queue_manager_video_information_user_dialog_message",
                            author,
                            title,
                            description
                        )
