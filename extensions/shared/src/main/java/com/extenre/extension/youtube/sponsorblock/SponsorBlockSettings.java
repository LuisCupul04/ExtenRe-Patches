...
import com.extenre.extension.youtube.sponsorblock.ui.SponsorBlockPreferenceGroup;
...
public class SponsorBlockSettings {
    ...
    public static void importDesktopSettings(@NonNull String json) {
        ...
        try {
            ...
            Utils.showToastShort(str("extenre_sb_settings_import_successful"));
        } catch (Exception ex) {
            Logger.printInfo(() -> "failed to import settings", ex); // Use info level, as we are showing our own toast.
            Utils.showToastShort(str("extenre_sb_settings_import_failed", ex.getMessage()));
        }
    }
    ...
    public static String exportDesktopSettings() {
        ...
        try {
            ...
            Utils.showToastShort(str("extenre_sb_settings_export_failed", ex));
            return "";
        }
    }
    ...
    private static void showExportWarningIfNeeded(@Nullable Context dialogContext) {
        ...
        if (dialogContext != null && SponsorBlockSettings.userHasSBPrivateId()
            ...
            Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                    dialogContext,
                    null, // No title.
                    str("extenre_sb_settings_extenre_export_user_id_warning"), // Message.
                    null, // No EditText.
                    null, // OK button text.
                    () -> {
                    }, // OK button action (dismiss only).
                    null, // No cancel button action.
                    str("extenre_sb_settings_extenre_export_user_id_warning_dismiss"), // Neutral button text.
