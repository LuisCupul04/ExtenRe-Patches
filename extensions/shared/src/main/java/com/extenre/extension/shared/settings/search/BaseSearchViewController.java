...
package com.extenre.extension.shared.settings.search;

import static com.extenre.extension.shared.utils.ResourceUtils.getDrawableIdentifier;
import static com.extenre.extension.shared.utils.ResourceUtils.getIdIdentifier;
import static com.extenre.extension.shared.utils.ResourceUtils.getMenuIdentifier;
import static com.extenre.extension.shared.utils.ResourceUtils.getStringIdentifier;
...
import com.extenre.extension.shared.settings.AppLanguage;
import com.extenre.extension.shared.settings.BaseSettings;
import com.extenre.extension.shared.settings.Setting;
import com.extenre.extension.shared.settings.preference.ColorPickerPreference;
import com.extenre.extension.shared.settings.preference.CustomDialogListPreference;
import com.extenre.extension.shared.settings.preference.NoTitlePreferenceCategory;
...
public abstract class BaseSearchViewController {
    ...
    protected static final int ID_EXTENRE_SEARCH_VIEW = getIdIdentifier("extenre_search_view");
    protected static final int ID_EXTENRE_SEARCH_VIEW_CONTAINER = getIdIdentifier("extenre_search_view_container");
    protected static final int ID_ACTION_SEARCH = getIdIdentifier("action_search");
    protected static final int ID_EXTENRE_SETTINGS_FRAGMENTS = getIdIdentifier("extenre_settings_fragments");
    public static final int DRAWABLE_EXTENRE_SETTINGS_SEARCH_ICON =
            getDrawableIdentifier("extenre_settings_search_icon");
    protected static final int MENU_EXTENRE_SEARCH_MENU =
            getMenuIdentifier("extenre_search_menu");
    ...
    private String getString(String str) {
        ...
        if (mActivity != null) {
            AppLanguage language = BaseSettings.EXTENRE_LANGUAGE.get();
    ...
    private void initializeSearchView() {
        ...
        searchView = activity.findViewById(ID_EXTENRE_SEARCH_VIEW);
        ...
        searchContainer = activity.findViewById(ID_EXTENRE_SEARCH_VIEW_CONTAINER);

        String rvxSettingsLabel = getString("extenre_settings_title");
        String searchLabel = getString("extenre_settings_search_title");
        ...
        AppLanguage appLanguage = BaseSettings.EXTENRE_LANGUAGE.get();
    ...
    private void initializeOverlayContainer() {
        ...
        FrameLayout mainContainer = activity.findViewById(ID_EXTENRE_SETTINGS_FRAGMENTS);
    ...
    protected void setupToolbarMenu() {
        toolbar.inflateMenu(MENU_EXTENRE_SEARCH_MENU);
    ...
    protected void filterAndShowResults(String query) {
        ...
        if (filteredSearchItems.isEmpty()) {
            ...
            noResultsPreference.setTitle(str("extenre_settings_search_no_results_title", query));
            noResultsPreference.setSummary(str("extenre_settings_search_no_results_summary"));
            noResultsPreference.setSelectable(false);
            noResultsPreference.setIcon(DRAWABLE_EXTENRE_SETTINGS_SEARCH_ICON);
