...
public class WebViewPreference extends Preference implements Preference.OnPreferenceClickListener {
    ...
    private final String[] labels = {
            "extenre_webview_intent_clear_cookies_on_startup",
            "extenre_webview_intent_clear_cookies_on_shutdown",
            "extenre_webview_intent_use_desktop_user_agent"
    };
