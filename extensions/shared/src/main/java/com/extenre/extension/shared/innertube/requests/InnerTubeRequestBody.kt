...
package com.extenre.extension.shared.innertube.requests
...
import com.extenre.extension.shared.requests.Route.CompiledRoute
...
object InnerTubeRequestBody {
    ...
    fun createPlaylistRequestBody(
        ...
        try {
            ...
            innerTubeBody.put("title", str("extenre_queue_manager_queue"))
