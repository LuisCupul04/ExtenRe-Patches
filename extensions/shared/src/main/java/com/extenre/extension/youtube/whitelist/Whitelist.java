...
package com.extenre.extension.youtube.whitelist;

import static com.extenre.extension.shared.utils.BaseThemeUtils.getAppForegroundColor;
...
import static com.extenre.extension.shared.utils.Utils.createCornerRadii;
...
public class Whitelist {
    ...
    private static void addToWhitelist(WhitelistType whitelistType, String channelId, String channelName, Context context) {
        ...
        if (updateWhitelist(whitelistType, whitelisted)) {
            showDialogOrToast(context, str("extenre_whitelist_added", channelName, friendlyName));
        } else {
    ...
    public static void removeFromWhitelist(WhitelistType whitelistType, String channelId, Context context) {
        ...
        String friendlyName = whitelistType.getFriendlyName();
        if (updateWhitelist(whitelistType, whitelisted)) {
            showDialogOrToast(context, str("extenre_whitelist_removed", channelName, friendlyName));
        } else {
    ...
    private static void showDialogOrToast(Context context, String message) {
        if (context == null) {
            ...
            message = message + "\n \n" + str("extenre_whitelist_reload_video");
        }
        // Create the custom dialog.
        Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                context,
                str("extenre_whitelist_settings_title"), // Title.
                message,                    // Message.
                null,                       // No EditText.
                null,                       // OK button text.
