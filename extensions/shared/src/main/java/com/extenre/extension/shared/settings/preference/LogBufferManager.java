...
public final class LogBufferManager {
    ...
    public static void exportToClipboard() {
        ...
        try {
            ...
            Utils.showToastShort(str("extenre_debug_logs_copied_to_clipboard"));
            ...
            Utils.showToastShort(str("extenre_debug_logs_failed_to_copy_to_clipboard"));
        }
    }
    ...
    public static String exportToString() {
        try {
            ...
            if (logBuffer.isEmpty()) {
                Utils.showToastShort(str("extenre_debug_logs_none_found"));
            ...
            String errorMessage = String.format(str("extenre_debug_logs_failed_to_export"), ex.getMessage());
    ...
    public static void clearLogBuffer() {
        ...
        Utils.showToastShort(str("extenre_debug_logs_clear_toast"));
        clearLogBufferData();
    }
}
