    ...
    protected void showDialog(Bundle state) {
        try {
            ...
            Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                    context,
                    str("extenre_preference_screen_import_export_title"), // Title.
                    ...
                    str("extenre_settings_import_copy"), // Neutral button (Copy) text.
                    () -> {
                        // Neutral button (Copy) action. Show the user the settings in JSON format.
                        Utils.setClipboard(editText.getText().toString(), str("extenre_share_copy_settings_success"));
                    },
