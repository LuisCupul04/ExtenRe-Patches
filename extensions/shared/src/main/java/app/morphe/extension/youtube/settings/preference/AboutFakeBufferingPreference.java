...
public class AboutFakeBufferingPreference extends Preference implements Preference.OnPreferenceClickListener {
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                context,
                // Title.
                str("extenre_spoof_streaming_data_use_js_bypass_fake_buffering_dialog_title"),
                // Message.
                str("extenre_spoof_streaming_data_use_js_bypass_fake_buffering_dialog_message"),
                // No EditText.
                null,
                // OK button text.
                null,
                ...
                null,
                // Neutral button text.
                str("extenre_spoof_streaming_data_use_js_bypass_fake_buffering_dialog_open_text"),
