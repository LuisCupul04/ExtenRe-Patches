...
public class VideoQualityPatch {
    ...
    public static void saveDefaultQuality(int qualityResolution) {
        ...
        if (Utils.getNetworkType() == Utils.NetworkType.MOBILE) {
            networkTypeMessage = str("extenre_remember_video_quality_mobile");
            qualitySetting = shortPlayerOpen ? shortsQualityMobile : videoQualityMobile;
        } else {
            networkTypeMessage = str("extenre_remember_video_quality_wifi");
        ...
        if (Settings.REMEMBER_VIDEO_QUALITY_LAST_SELECTED_TOAST.get()) {
            ...
            Utils.showToastShort(str(
                    shortPlayerOpen
                            ? "extenre_remember_video_quality_toast_shorts"
                            : "extenre_remember_video_quality_toast",
                    networkTypeMessage,
                    qualityLabel)
            );
        }
