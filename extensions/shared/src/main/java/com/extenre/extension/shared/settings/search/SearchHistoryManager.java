...
import static com.extenre.extension.shared.settings.BaseSettings.SETTINGS_SEARCH_ENTRIES;
import static com.extenre.extension.shared.settings.BaseSettings.SETTINGS_SEARCH_HISTORY;
...
import com.extenre.extension.shared.settings.preference.BulletPointPreference;
...
public class SearchHistoryManager {
    ...
    SearchHistoryManager(Activity activity, FrameLayout overlayContainer,
        ...
        clearHistoryButton.setOnClickListener(v -> createAndShowDialog(
                str("extenre_settings_search_clear_history"),
                str("extenre_settings_search_clear_history_message"),
                this::clearAllSearchHistory
        ));

        // Set up search tips summary.
        CharSequence text = BulletPointPreference.formatIntoBulletPoints(
                str("extenre_settings_search_tips_summary"));
    ...
    protected void showEmptyHistoryViews(TextView emptyTitle, TextView emptySummary) {
        ...
        emptyTitle.setText(str("extenre_settings_search_empty_history_title"));
        emptySummary.setVisibility(View.VISIBLE);
        emptySummary.setText(str("extenre_settings_search_empty_history_summary"));
    }
        ...
        public void notifyDataSetChanged() {
            ...
            for (String query : history) {
                ...
                deleteIcon.setOnClickListener(v -> createAndShowDialog(
                        query,
                        str("extenre_settings_search_remove_message"),
                        () -> {
