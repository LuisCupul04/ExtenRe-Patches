...
package com.extenre.extension.music.patches.navigation;

import static com.extenre.extension.music.utils.ExtendedUtils.IS_6_27_OR_GREATER;
import static com.extenre.extension.music.utils.ExtendedUtils.IS_8_29_OR_GREATER;
...
public class NavigationPatch {
    ...
    public static int enableCustomNavigationBarColor() {
        try {
            ...
            Utils.showToastShort(str("extenre_custom_navigation_bar_color_value_invalid_invalid_toast"));
