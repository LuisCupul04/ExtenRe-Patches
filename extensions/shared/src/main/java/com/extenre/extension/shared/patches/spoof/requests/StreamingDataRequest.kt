...
package com.extenre.extension.shared.patches.spoof.requests
...
import com.extenre.extension.shared.innertube.requests.InnerTubeRequestBody.createApplicationRequestBody
import com.extenre.extension.shared.innertube.requests.InnerTubeRequestBody.createJSRequestBody
import com.extenre.extension.shared.innertube.requests.InnerTubeRequestBody.getInnerTubeResponseConnectionFromRoute
import com.extenre.extension.shared.innertube.requests.InnerTubeRoutes.getStreamingDataRoute
import com.extenre.extension.shared.innertube.utils.PlayerResponseOuterClass.PlayerResponse
import com.extenre.extension.shared.innertube.utils.StreamingDataOuterClassUtils.getAdaptiveFormats
import com.extenre.extension.shared.innertube.utils.StreamingDataOuterClassUtils.getFormats
import com.extenre.extension.shared.innertube.utils.StreamingDataOuterClassUtils.setServerAbrStreamingUrl
import com.extenre.extension.shared.innertube.utils.StreamingDataOuterClassUtils.setUrl
import com.extenre.extension.shared.innertube.utils.ThrottlingParameterUtils
import com.extenre.extension.shared.patches.AppCheckPatch.IS_YOUTUBE
...
import com.extenre.extension.shared.patches.spoof.StreamingDataOuterClassPatch.parseFrom
...
class StreamingDataRequest private constructor(
    ...
    companion object {
        ...
        private fun fetch(
            ...
            handleConnectionError(
                str("extenre_spoof_streaming_data_failed_forbidden"),
                null,
                true
            )
            if (!SPOOF_STREAMING_DATA_DEFAULT_CLIENT.name.startsWith("TV")) {
                handleConnectionError(
                    str("extenre_spoof_streaming_data_failed_forbidden_suggestion"),
                    null,
                    true
                )
            }
