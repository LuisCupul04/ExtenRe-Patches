...
import com.extenre.extension.shared.ui.ColorDot;
...
public class ColorPickerPreference extends EditTextPreference {
    ...
    public static final int ID_EXTENRE_COLOR_PICKER_VIEW =
            ResourceUtils.getIdIdentifier("extenre_color_picker_view");
    public static final int ID_PREFERENCE_COLOR_DOT =
            ResourceUtils.getIdIdentifier("preference_color_dot");
    public static final int LAYOUT_EXTENRE_COLOR_DOT_WIDGET =
            ResourceUtils.getLayoutIdentifier("extenre_color_dot_widget");
    public static final int LAYOUT_EXTENRE_COLOR_PICKER =
            ResourceUtils.getLayoutIdentifier("extenre_color_picker");
    ...
    private void init() {
        ...
        setWidgetLayoutResource(LAYOUT_EXTENRE_COLOR_DOT_WIDGET);
    }
    ...
    protected void showDialog(Bundle state) {
        ...
        View colorPicker = LayoutInflater.from(context).inflate(LAYOUT_EXTENRE_COLOR_PICKER, null);
        dialogColorPickerView = colorPicker.findViewById(ID_EXTENRE_COLOR_PICKER_VIEW);
        ...
        Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                context,
                getTitle() != null ? getTitle().toString() : str("extenre_settings_color_picker"),
                null,
                null,
                null,
                () -> { // OK button action.
                ...
                str("extenre_settings_reset_color"), // Neutral button text.
