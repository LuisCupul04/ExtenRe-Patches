...
import static com.extenre.extension.shared.settings.BaseSettings.DEBUG;
import static com.extenre.extension.shared.settings.BaseSettings.DEBUG_TOAST_ON_ERROR;
...
public class Logger {
     ...
     */
    private static final String EXTENRE_LOG_TAG_PREFIX = "Extended: ";
    ...
    private static void logInternal(LogLevel logLevel, LogMessage message, @Nullable Throwable ex, boolean showToast) {
        ...
        String logTag = EXTENRE_LOG_TAG_PREFIX + className;
        switch (logLevel) {
            case DEBUG:
