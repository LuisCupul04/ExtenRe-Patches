...
import static com.extenre.extension.shared.utils.Utils.getChildViewByResourceName;
import static com.extenre.extension.youtube.utils.ExtendedUtils.isFullscreenHidden;
...
import com.extenre.extension.youtube.patches.player.PlayerPatch;
    ...
    public static void initialize(ViewGroup viewGroup) {
        try {
            ...
            skipHighlightButtonRef = new WeakReference<>(
                    Objects.requireNonNull(getChildViewByResourceName(layout, "extenre_sb_skip_highlight_button")));
            skipSponsorButtonRef = new WeakReference<>(
                    Objects.requireNonNull(getChildViewByResourceName(layout, "extenre_sb_skip_sponsor_button")));
            NewSegmentLayout newSegmentLayout = Objects.requireNonNull(
                    getChildViewByResourceName(layout, "extenre_sb_new_segment_view"));
